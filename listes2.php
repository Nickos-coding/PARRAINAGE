...
$filiere = isset($_GET['filiere']) ? $_GET['filiere'] : 2;'';
...
<body>
    ...
    <main>
        ...
        <form action="listes2.php" method="GET" class="form-container">
        ...
        <div class="admin-back" id="end">
            <a href="page_adminSEG.php" class="btn-back">Retour au tableau de bord</a>
        </div>
    </main>
