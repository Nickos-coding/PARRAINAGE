...
$filiere = isset($_GET['filiere']) ? $_GET['filiere'] : 5;'';
...
<body>
    ...
    <main>
        ...
        <form action="listes5.php" method="GET" class="form-container">
        ...
        <div class="admin-back" id="end">
            <a href="page_adminDRT.php" class="btn-back">Retour au tableau de bord</a>
        </div>
    </main>
