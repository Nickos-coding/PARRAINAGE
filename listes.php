...
// Récupérer les filières et niveaux pour afficher dans les menus déroulants
$queryFilieres = "SELECT * FROM filieres";
$filieres = $pdo->query($queryFilieres)->fetchAll();
...
<body>
    ...
    <main>
        ...
        <form action="listes.php" method="GET" class="form-container">
            ...
            <select name="filiere">
                ...
                <?php foreach ($filieres as $filiereOption): ?>
                    <option value="<?php echo $filiereOption['idfil']; ?>" <?php echo ($filiere == $filiereOption['idfil']) ? 'selected' : ''; ?>>
                        <?php echo $filiereOption['nom_filiere']; ?>
                    </option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="admin-back" id="end">
            <a href="page_admin.php" class="btn-back">Retour au tableau de bord</a>
        </div>
    </main>
