...
<body>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="formulaire_parrainageCOM.php">Créer une liste de parrainage</a></li>
                    </ul>
                </li>
    ...
    <main>
        ...
        <div id="form-etudiant" class="content-section hidden">
            ...
            <form method="POST" action="ajouter_etudiants.php">
                ...
                <select id="filiere" name="filiere" required>
                    ...
                    $filieres = $pdo->query("SELECT * FROM filieres where idfil = 4")->fetchAll();
        ...
        <div id="voir-parrainages" class="content-section hidden">
            ...
            <form method="GET" action="voir_parrainageCOM.php">
