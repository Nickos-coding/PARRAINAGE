...
<body>
    ...
    <header>
        ...
        <nav class="nav-links">
            <ul>
                ...
                <li><a href="listes2.php">Listes</a></li>
                <li class="dropdown">
                    <a href="#">Parrainage</a>
                    <ul class="dropdown-menu">
                        <li><a href="#" class="menu-link" data-section="voir-parrainages">Voir les parrainages</a></li>
                        <li><a href="formulaire_parrainageSEG.php">Créer une liste de parrainage</a></li>
                    </ul>
                </li>
    ...
    <main>
        ...
        <div id="form-etudiant" class="content-section hidden">
            ...
            <form method="POST" action="ajouter_etudiants.php">
                ...
                <select id="filiere" name="filiere" required>
                    ...
                    $filieres = $pdo->query("SELECT * FROM filieres where idfil = 2")->fetchAll();
        ...
        <div id="voir-parrainages" class="content-section hidden">
            ...
            <form method="GET" action="voir_parrainageSEG.php">
