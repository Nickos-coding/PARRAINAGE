...
$filiere = isset($_GET['filiere']) ? $_GET['filiere'] : 4;'';
...
<body>
    ...
    <main>
        ...
        <form action="listes4.php" method="GET" class="form-container">
        ...
        <div class="admin-back" id="end">
            <a href="page_adminCOM.php" class="btn-back">Retour au tableau de bord</a>
        </div>
    </main>
